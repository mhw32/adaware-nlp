...
import pickle
from gensim import models # gensim and word2vec will be removed later once we develop our own word embedding
...
def train_blstm(
    ...
    def training_loss(params, iter):
        ...
        log_lik = -log_likelihood(params, X_train[:,sample_indices,:], 
                Y_train[:,sample_indices,:], train_mask[sample_indices], 
