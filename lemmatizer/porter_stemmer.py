class PorterStemmer:
    ''' Hardcoded Stemmer: it maps words to lemmas using inflection ending
        rules and exception lists. This fails to take into account the surrounding
        semantics but is very fast.
    '''
